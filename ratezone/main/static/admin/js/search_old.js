...
const names = [
//  { name: "Hussain" },
  { name: "Hussain Almohri", directLink: true, id: 11},
//  { name: "Mohamad" },
//  { name: "Selman" },
  { name: "Mohamad Smaoui", directLink: true, id: 17},
  { name: "Mohamad Soud", directLink: true, id: 30},
  { name: "Naser AlDuaij", directLink: true, id: 19},
  { name: "Maha Alabduljaleel", directLink: true, id: 13},
];
